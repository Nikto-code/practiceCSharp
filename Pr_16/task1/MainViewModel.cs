...
namespace task1
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        private readonly FinanceStorageService _storageService = new FinanceStorageService();
        ...
        public ObservableCollection<Transaction> FilteredTransactions =>
            _financeViewModel.FilteredTransactions;

        public ObservableCollection<CategorySummary> CategorySummaries =>
            _financeViewModel.CategorySummaries;
        ...
        public MainViewModel()
        {
            ...
            SendNotificationCommand = new RelayCommand(_ =>
            {
                _notificationService.SendNotification(
                    $"Напоминание: текущий баланс {Balance} руб. [{DateTime.Now:HH:mm}]");
        ...
        {
            var data = _storageService.LoadTransactions();
            foreach (var item in data)
            {
                ...
                _financeViewModel.AddTransaction(t);
            }
            OnPropertyChanged(nameof(Balance));
        }
        ...
        {
            var models = _financeViewModel.Transactions.Select(t => new TransactionModel
            {
                Date = t.Date,
                Category = t.Category,
                Amount = t.Amount
            });
            _storageService.SaveTransactions(models);
        }
